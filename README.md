...
Скрипт выставляет статус «онлайн» в Telegram по расписанию. Работает через Telethon — напрямую как клиент, не бот. Telegram сбрасывает онлайн через ~5 минут без активности, поэтому каждая сессия автоматически разбивается на блоки по 30 секунд.
